        ...
        <aside class="w-64 bg-warm-950 text-white shrink-0 hidden lg:block">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.refunds.index') }}"
                    class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.refunds.*') ? 'bg-primary-600 text-white' : 'text-warm-300 hover:bg-warm-800 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="mobile-sidebar-overlay" class="fixed inset-0 bg-black/50 z-40 hidden lg:hidden">
        <aside class="w-64 bg-warm-950 text-white h-full overflow-y-auto">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.refunds.index') }}"
                    class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-warm-300 hover:bg-warm-800 hover:text-white">Refunds</a>
            </nav>
        </aside>
    </div>
